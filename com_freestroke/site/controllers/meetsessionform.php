 ...
 */
class FreestrokeControllerMeetsessionForm extends JControllerLegacy {
	...
	public function display($cachable = false, $urlparams = false) {
		$view = $this->getView('Meetsessionform', 'html');
...
// 		$previousId = ( int ) $app->getUserState('com_freestroke.edit.meetsession.id');
		...
		// Get the model.
// 		$model = $this->getModel('MeetsessionForm', 'FreestrokeModel');
		
		// Redirect to the edit screen.
		$this->setRedirect(JRoute::_('index.php?option=com_freestroke&view=meetsession&layout=edit', false));
	}
	...
	public function save() {
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_freestroke&task=meetsession.edit&layout=edit&id=' . $id, false));
			return false;
		}
		...
		$this->setRedirect($this->getReturnRoute($id));
	
		// Flush the data from the session.
		$app->setUserState('com_freestroke.edit.meetsesssion.data', null);
	 ...
	 * @param unknown $id
	 */
	private function getReturnRoute($id) {
		$app = JFactory::getApplication();
		$returnView = $app->getUserState('com_freestroke.edit.meetsession.return');
		if(empty($returnView)) {
			$returnView = "meet";
		}
		$app->setUserState('com_freestroke.edit.meetsession.return', null);
		return JRoute::_('index.php?option=com_freestroke&view='.$returnView.'&id=' . $id, false);
	}
