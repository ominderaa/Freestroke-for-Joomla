 ...
 */
class FreestrokeControllerMeetForm extends JControllerLegacy
{
...
// 		$previousId = (int) $app->getUserState('com_freestroke.edit.meet.id');
		...
		// Get the model.
// 		$model = $this->getModel('MeetForm', 'FreestrokeModel');

		// Redirect to the edit screen.
		$this->setRedirect(JRoute::_('index.php?option=com_freestroke&view=meet&layout=edit', false));
	}
	...
	public function save()
	{
		...
		$app	= JFactory::getApplication();
		$model = $this->getModel('MeetForm', 'FreestrokeModel');
		$editid = (int)$app->getUserState('com_freestroke.edit.meet.id');
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_freestroke&view=meetform&layout=edit&id='.$id, false));
			return false;
		}
        ...
        $menu = & JSite::getMenu();
        $item = $menu->getActive();
        $this->setRedirect(JRoute::_('index.php?option=com_freestroke&view=meet&id='.$editid, false));
