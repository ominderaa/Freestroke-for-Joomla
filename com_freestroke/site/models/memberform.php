 ...
 * Freestroke model.
 */
class FreestrokeModelMemberForm extends JModelForm
{
	...
	protected function populateState()
	{
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_freestroke.edit.member.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_freestroke.edit.member.id', $id);
        }
        ...
        if(isset($params_array['item_id'])){
            $this->setState('member.id', $params_array['item_id']);
        }
	...
	{
		// Get the form.
		$form = $this->loadForm('com_freestroke.member', 'memberform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$id = (!empty($data['id'])) ? $data['id'] : (int)$this->getState('member.id');
