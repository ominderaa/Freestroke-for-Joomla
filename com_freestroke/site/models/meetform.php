 ...
 * Freestroke model.
 */
class FreestrokeModelMeetForm extends JModelForm
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_freestroke.meet', 'meetform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$data = JFactory::getApplication()->getUserState('com_freestroke.edit.meet.data', array());
        if (empty($data)) {
            $data = $this->getData();
        }
