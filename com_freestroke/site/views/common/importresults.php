<div style="display: none">
	<div id="importResultsFormDiv">
		<form action="<?php echo JRoute::_('index.php?option=com_freestroke&task=meet.lxfimportresults'); ?>" method="post" id="importForm" name="importForm"
			enctype="multipart/form-data">
			<fieldset>
				<legend><?php echo JText::_('COM_FREESTROKE_MEETS_IMPORTRESULTS_TITLE'); ?></legend>
				<?php echo sprintf(JText::_( 'COM_FREESTROKE_MEETS_IMPORTRESULTS_INSTRUCTIONS' ), $this->item->name); ?>
				<table class="adminformlist">
					...
					<tr>
						<td><label for="deleteresults"><?php echo JText::_( 'COM_FREESTROKE_MEETS_IMPORTRESULTS_OVERWRITERESULTS' ).':'; ?></label></td>
						<td><input type="checkbox" id="deleteresults" name="deleteresults" value="deleteresults" checked /></td>
					</tr>
					<tr>
