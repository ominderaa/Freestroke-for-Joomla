...
<form action="<?php echo JRoute::_('index.php?option=com_freestroke&task=meetscalendar.lxfimportresults'); ?>" method="post" id="importForm"  name="importForm" enctype="multipart/form-data">
	<fieldset>
		...
		<table class="adminformlist">
			...
			<tr>
				...
				<td>
					<input type="checkbox" id="deleteresults"  name="deleteresults" value="deleteresults" checked />
				</td>
			</tr>
			<tr>
				<td colspan="2">
