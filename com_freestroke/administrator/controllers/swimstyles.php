...
/**
 * Swimstyles list controller class.
 */
class FreestrokeControllerSwimstyles extends JControllerAdmin {
	/**
	 * Proxy for getModel.
	 * 
	 ...
	 * @since 1.6
	 */
	public function getModel($name = 'swimstyle', $prefix = 'FreestrokeModel', $config = Array()) {
