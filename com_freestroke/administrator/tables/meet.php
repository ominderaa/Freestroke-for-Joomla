 ...
 * meet Table class
 */
class FreestrokeTablemeet extends JTable {
	...
	public function __construct(&$db) {
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'FreestrokeTablemeet', array('typeAlias' => 'com_freestroke.meet'));
		parent::__construct('#__freestroke_meets', 'id', $db);
	}
	...
	public function bind($array, $ignore = '') {
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_freestroke.meet.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_freestroke/access.xml',
				"/access/section[@name='meet']/"
			);
			$default_actions = JAccess::getAssetRules('com_freestroke.meet.' . $array['id'])->getData();
			$array_jaccess   = array();
	 ...
	 *
	 * @param
	 *        	mixed An optional array of primary key values to update. If not
	...
	protected function _getAssetName() {
		$k = $this->_tbl_key;
		return 'com_freestroke.meet.' . ( int ) $this->$k;
	}
