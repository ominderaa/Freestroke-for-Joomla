 ...
 * member Table class
 */
class FreestrokeTablerelayposentrie extends JTable {
	...
	public function __construct(&$db) {
		...
		parent::__construct ( '#__freestroke_relayposentries', 'id', $db );
	}
	...
	public function bind($array, $ignore = '') {
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_freestroke.relayposentrie.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
					JPATH_ADMINISTRATOR . '/components/com_freestroke/access.xml',
					"/access/section[@name='member']/"
					);
			$default_actions = JAccess::getAssetRules('com_freestroke.relayposentry.' . $array['id'])->getData();
			$array_jaccess   = array();
